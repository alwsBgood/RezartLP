                    ...
                    <div class="calculator-left clearfix">
                        <div class="calculator-sliders">
                            <div class="calculator-group">
                                ...
                                <div class="calculator-slider ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" id="count">
                                    <div class="ui-slider-range ui-widget-header ui-corner-all ui-slider-range-min"></div>
                                    <span class="ui-slider-handle ui-state-default ui-corner-all" tabindex="0"></span>
                                </div>
                                <input type="hidden" id="valCount" value="140">
                            </div>
                            <div class="calculator-group">
                                <label class="calculator-group_label clearfix">
                                ...
                                <input type="hidden" id="valConv" value="4">
                            </div>
                            <div class="calculator-group">
                                <label class="calculator-group_label clearfix">
                                ...
                                <div class="calculator-slider ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" id="money">
                                    <div class="ui-slider-range ui-widget-header ui-corner-all ui-slider-range-min"></div>
                                    <span class="ui-slider-handle ui-state-default ui-corner-all" tabindex="0"></span>
                                </div>
                                <input type="hidden" id="valMoney" value="150">
                            </div>
                        </div>
                    </div>
        ...
        <div class="grid_6">
            <ul>
                ...
                <li class="rotate_block">
                    ...
                    <p class="price"><span>от</span> 450$</p>
                </li>
                <li class="rotate_block">
                    <p class="text">Продающий копирайтинг</p>
                    <p class="price"><span>от</span> 250$</p>
                </li>
            </ul>
        </div>
    </div>
...
<section id="sec_11">
    <div class="container_12">
        <div class="grid_6">
            ...
            <p class="text">Когда я пришел в GM я был рядовым специалистом <br />в команде технической поддержки, нас тогда было двое. В скором времени я принял на себя <br /> ответственность и стал разрабатывать простые (шаблонные) сайты на Wordpress для участников наших клиентов. </p>
        ...
        <div class="grid_6">
            ...
            <p class="text">Не стану идеализировать наш опыт и нашу схему, <br /> но она работает и работает эффективно. Тот факт, <br /> что наша студия производит около 60 проектов каждый месяц (наш рекорд 80). Да - это не высокотехнологичные платформы, а продающие одностраничники в основном. Но несмотря на это - каждый из них идеально адаптивен, <br /> с проработанным маркетингом и копирайтом, а также <br /> с авторским дизайном.</p>
        ...
        <div class="grid_6">
            ...
            <p class="text">В каждой команде есть несколько дизайнеров, несколько front-end разработчиков и копирайтер. Так вот все, в своей команде, имеют одинаковый квалификационный уровень. <br /> Я горжусь своей командой! Какой итог? Здоровая <br /> профессиональная конкуренция, стремление брать <br /> на себя ответственность, выполнять проекты еще более качественно. От этого на выходе продукт становится лучше.</p>
        </div>
        <div class="grid_6">
